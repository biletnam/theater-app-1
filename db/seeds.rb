...
9.times { Movie.create!(title: Faker::Book.title, director: Faker::Name.name, synopsis: Faker::Lorem.sentence, run_time: rand(10..180), cost: Faker::Number.decimal(2)) }
puts "Movies successfully seeded!"

3.times { Auditorium.create!(name: Faker::Lorem.word.capitalize, capacity: rand(100..300))}
