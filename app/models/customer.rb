class Customer < ApplicationRecord
	...
	validates :cc_expiration_month, presence: true, numericality: { only_integer: true, greater_than: 0, less_than: 13 }, length: { minimum: 1, maximum: 2 }
	validates :cc_expiration_year, presence: true, numericality: { only_integer: true, greater_than: 1980 }, length: { is: 4 }
